    ...
    function completeHandler(event) {
       ...
       //advert random....Anime
        ...
        function completeHandler(event) {
         ...
         //multiple advert random
         var formdata = new FormData();
         formdata.append("type", "Thick Vertical"); //type I am looking for 
         formdata.append("tags", "tech, food,fashion"); //tags that might be randoms
...
//multiple tags 
    ...
    ajax.open("POST", "https://ad.simaneka.com/api/get");
    ajax.setRequestHeader("authorisation", "HwTHYpCv80Tj8JGFETHdMVJLE73kSeqZ");
    ajax.send(formdata1);
    ...
    var ajax = new XMLHttpRequest();
    aja.addEventListener("load", completeHandler3, false);
    ajax.open("POST", "https://ad.simaneka.com/api/get");
    ajax.setRequestHeader("authorisation", "HwTHYpCv80Tj8JGFETHdMVJLE73kSeqZ");
    ajax.send(formdata3);
